...
def run_simulation(n_cs, K_std, iterations, leakage, initial_c_conc, initial_abundance,
    ...
    while k < iterations:
        ...
        try:
            ...
            if has_converged(c.N) and not numerical_error(c.N) and sol.success:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--N_cs", help = 'The number of different sizes of CS', default=8, type=int)
    ...
    parser.add_argument("--N_K_std", help = 'Number of different K std values', default = 7, type=int)
    ...
    parser.add_argument("--csp_max", help = 'Maximal C_sparsity', default = 0.5, type=float)
    parser.add_argument("--N_Csp", help = 'Number of different C sparsity values', default = 6, type=int)
